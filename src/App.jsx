  ...
  return (
    <div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-end", fontFamily: "'Montserrat',sans-serif", fontSize: "1em", marginBottom: 6 }}>
      {groups.map((g, i) => {
        ...
        // A cifra fica na linha de cima (mantém a altura, fica ACIMA da letra),
        // mas quando há letra a cifra não ocupa largura no fluxo (width:0 +
        // overflow visível): assim uma cifra larga sobre sílaba curta transborda
        // para a direita sem empurrar a letra nem partir a palavra.
        // Acorde solto (sem letra) ocupa largura normal e ganha respiro à direita.
        return (
          <span key={i} style={{ display: "inline-flex", flexDirection: "column", justifyContent: "flex-end" }}>
            <span style={{
              height: "1.5em", lineHeight: "1.5em", color: chordColor, fontWeight: 700,
              fontSize: "0.9em", whiteSpace: "pre",
              width: emptyText ? "auto" : 0,
              overflow: emptyText ? "visible" : "visible",
              paddingRight: emptyText ? "0.6em" : 0,
            }}>
              {chordStr}
            </span>
...
function exportSongPDF(song, soundingKey, shapeShift, shapeUseFlats, capo, shapeKey) {
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    ...
    .ch.float { width:0; overflow:visible; }
